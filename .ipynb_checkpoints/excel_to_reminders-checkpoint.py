...
'''def setupAppointment(date, title, recipients, prop, freq):    
    appt = outlook.CreateItem(1) # AppointmentItem
    appt.Start = date #"2020-11-28 10:10 yyyy-MM-dd hh:mm
    appt.Subject = title
    appt.Duration = 1 # In minutes (60 Minutes)
    appt.Location = prop
    appt.Recipients.Add(recipients) # Don't end ; as delimiter
